...
- **Vorschau-Qualität** (seit 07.09.2026) — Einstellungen → Karten, ganz unten: «voll» (wie das Video), «flott» (viermal weniger Kacheln je Bild, Kacheldichte wie vor dem 07.09.) oder «schnell» (dazu halbe Auflösung auf Retina und gröberes Geländenetz). Hilft, wenn die Vorschau ruckelt. Betrifft nur das Fenster: Video und Standbild rendern immer voll, Kamera, Strecke und Overlays sind identisch. Die App lädt die Oberfläche nach dem Umstellen neu.
