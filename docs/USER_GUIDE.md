...
- **Relief, Dunst und Looks** (seit 17.09.2026) — in der „Luftbild-Optik": **Relief** legt Licht und Schatten aus den Geländedaten über die Luftbilder (Standard 35 %; 0 = aus), damit die flache Sentinel-2-Ebene Tiefe bekommt. **Dunst entfernen** (0–100 %, Standard 0) zieht den blauen Schleier aus Satellitenbildern heraus — technisch ein Schwarzpunkt je Farbkanal auf dem Kartenbild, in derselben Ebene wie die Schärfe; 15–35 % sind der Sweet Spot, mehr wirkt hart. In der „Karten-Optik" (OSM, OpenTopoMap …) gibt es „Dunst entfernen" ebenfalls. Die Auswahl **Look** (Natürlich / Kräftig / Filmisch) stellt alle sieben Regler auf einmal; „Eigene Einstellung" heißt: mindestens ein Regler weicht ab. Alles in Vorschau und Video gleich, rückgängig mit ⌘Z, nicht in den Web-Karten-Exporten.
