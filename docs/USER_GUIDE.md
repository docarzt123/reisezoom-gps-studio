...
- **GPX-Inspektor** 🔍 — Track reparieren: Ausreißer heilen, Lücken füllen, Höhe korrigieren, Punkte verschieben, Anfang/Ende abschneiden, Mittelstücke rausschneiden, mehrere Aufzeichnungen verbinden
  ...
  **Seit 25.09.2026 zeigt 🩹 Heilen zuerst eine Vorschau** („Vorschau — noch nichts geändert“: orange Ausreißer, magenta Lücken, die geplanten Track-Check-Schritte); erst **✓ Übernehmen** ändert den Track, *Abbrechen* verwirft. Lücken folgen einem Weg nur, wenn der gefundene Weg wirklich an beiden Enden der Lücke anliegt — sonst wird gerade gefüllt, statt den Track zur nächsten Straße springen zu lassen.
...
Die Schalter unter **„Auf der Karte anzeigen"** (Orte, Straßen, POIs, ÖPNV, Grenzen) funktionieren auch hier: Über den Luftbildern liegen die Beschriftungs-Ebenen von OpenFreeMap (OpenStreetMap-Daten, kostenlos, ohne Schlüssel), in Vorschau und Video gleich. Nicht in den Web-Karten-Exporten. Sind die Luftbilder flau, hilft die Gruppe **„Luftbild-Optik"**: Sättigung, Kontrast, Helligkeit, Farbton und Schärfe (Werk 25/8/0/0/0, „Standard" setzt zurück) — auf die Luftbilder und die Sentinel-Ebene (dort als Abweichung vom Werk, im Werk bleibt Sentinel unverändert), in Vorschau, Video und Web-Karte gleich; die Schärfe nicht in der Web-Karte. Seit 17.09.2026 dazu **Relief** (Licht und Schatten aus den Geländedaten über den Luftbildern, Werk 0 — die Looks schalten es ein), **Dunst entfernen** (nimmt den blauen Schleier aus Satellitenbildern, Werk 0) und oben die Auswahl **Look**: „Natürlich", „Kräftig" oder „Filmisch" stellen alle Regler auf einen abgestimmten Satz; wer danach einen Regler bewegt, sieht wieder „Eigene Einstellung". Relief und Dunst gibt es in Vorschau und Video, nicht in der Web-Karte.
...
### Kartenquellen & Schlüssel — was woher kommt, was es kostet, was du veröffentlichen darfst 🗺️

**Kurz:** Ohne irgendeinen Schlüssel hast du Satellitenbilder, Karten und 3D-Gelände — und darfst die Videos veröffentlichen. Schlüssel brauchst du nur für **MapTiler** (kostenlos) und **Mapbox** (kostenlos, aber Videos nur mit gekauften Rechten).

| Quelle | Schlüssel? | Kosten | Videos veröffentlichen? | Nennung im Bild |
|---|---|---|---|---|
| **Satellit (kostenlos)** — amtliche Luftbilder | nein | kostenlos | ja | automatisch (z. B. „Luftbild: PNOA © IGN España") |
| **OpenFreeMap** (Liberty, Bright, Positron) | nein | kostenlos, ohne Limit | ja | automatisch (© OpenMapTiles, © OpenStreetMap) |
| **OpenStreetMap, OpenTopoMap, CyclOSM, Humanitarian** | nein | kostenlos (Kacheldienste der Community, bitte nicht massenhaft) | ja | automatisch |
| **3D-Gelände** (AWS Terrain Tiles / Mapzen) | nein | kostenlos | ja | automatisch („Gelände: Mapzen/AWS Terrain Tiles") |
| **MapTiler** (Satellit, Hybrid, Outdoor, Topo, Streets + eigenes Gelände) | **ja** | Gratistarif (100.000 Kachelabrufe/Monat, **nur nicht-kommerziell**); Flex ab ca. 30 $/Monat | **ja, bis 100.000 Abonnenten** (Cloud Terms §5) | automatisch (© MapTiler © OpenStreetMap contributors) |
| **Mapbox** (Satellit 3D, Satellit + Straßen, Outdoor, Streets, Hell, Dunkel) | **ja** (Token `pk.…`) | Free-Tier 50.000 Karten-Loads/Monat, Kreditkarte bei Registrierung | **nur mit gekauften Videorechten** (Product Terms §1.7) | automatisch (© Mapbox © OpenStreetMap) |
...
- **Deutschland (Land für Land):** Baden-Württemberg (LGL), Bayern (Vermessungsverwaltung, CC BY 4.0), Berlin (TrueDOP), Brandenburg (LGB), Bremen (CC BY 4.0), Hessen (HVBG), Mecklenburg-Vorpommern, Niedersachsen (LGLN, CC BY 4.0), Nordrhein-Westfalen (Geobasis NRW), Rheinland-Pfalz, Saarland, Sachsen (GeoSN), Sachsen-Anhalt, Schleswig-Holstein (CC BY 4.0), Thüringen — meist unter „Datenlizenz Deutschland – Namensnennung 2.0". **Hamburg fehlt** (kein erreichbarer Dienst). Liegt der Track an einer Landesgrenze, legt die App die Nachbarländer übereinander.
- **Europa:** Österreich (basemap.at, CC BY 4.0), Schweiz (swisstopo), Luxemburg (CC0), Niederlande (PDOK, CC BY 4.0), Frankreich (IGN Géoplateforme), Spanien inkl. Kanaren (PNOA © IGN, CC BY 4.0), Portugal (DGT, CC BY 4.0), Italien (Geoportale Nazionale, 2012), Tschechien (ČÚZK), Polen (GUGiK), Estland (Maa-amet, CC BY 4.0), seit 17.09.2026 Belgien (Flandern: Digitaal Vlaanderen; Wallonien: SPW, CC BY 4.0) und Slowakei (ÚGKK SR/GKÚ, CC BY 4.0); seit 18.09.2026 Slowenien (GURS, CC BY 4.0). Mit eigenem, kostenlosem Schlüssel (Einstellungen → Karten → **Länder-Schlüssel**): Dänemark (Dataforsyningen), Finnland (Maanmittauslaitos), Neuseeland (LINZ) — ohne Schlüssel bleibt dort Sentinel-2, und der Stil-Hinweis sagt es. Außerhalb Europas: USA, Japan und New South Wales in Australien (Spatial Services, CC BY 4.0).
- **Welt:** Japan (GSI), USA inkl. Alaska und Hawaii (USGS, gemeinfrei).
- **Keine kostenlose Quelle** gibt es derzeit für Skandinavien, Großbritannien, Irland und Kanada — dort weicht die App auf die OpenFreeMap-Karte mit Gelände aus; für Satellit dort MapTiler nehmen.

#### MapTiler-Schlüssel besorgen (kostenlos, 3 Minuten)
1. Konto anlegen auf [cloud.maptiler.com](https://cloud.maptiler.com/) — E-Mail + Passwort oder Google/GitHub, **keine Kreditkarte**.
2. Bestätigungs-Mail klicken.
3. Links im Menü **API Keys** (direkt: [cloud.maptiler.com/account/keys](https://cloud.maptiler.com/account/keys/)). Dort liegt schon ein Schlüssel — kopieren (20 Zeichen, Buchstaben und Ziffern).
4. In der App: **Einstellungen → Kartenanbieter → MapTiler-Schlüssel** einfügen → Speichern. Die App lädt neu, die MapTiler-Stile stehen in der Liste.

> ⚠️ **Beim Schlüssel „Allowed HTTP origins" leer lassen.** Trägst du dort eine Website ein, sperrt MapTiler den Render aus (der läuft ohne Browser-Adresse) — die Vorschau ginge, das Video bliebe schwarz.
>
> 💡 **Gratistarif:** 100.000 Kachelabrufe pro Monat, das reicht für viele Renders. Er ist auf **nicht-kommerzielle Nutzung** begrenzt — für einen monetarisierten Kanal ist der Flex-Tarif (ca. 30 $/Monat) gedacht. Videos für Kanäle bis 100.000 Abonnenten sind laut MapTiler Cloud Terms §5 erlaubt; darüber vorher bei MapTiler nachfragen.

#### Mapbox-Token besorgen (kostenlos — aber lies erst den Hinweis)
Mapbox erlaubt die **Veröffentlichung von Videos** mit seinem Kartenmaterial **nur mit gekauften Videorechten** (Product Terms §1.7 „Print or Video Use"). Für YouTube, Instagram & Co. also einen kostenlosen Stil oder MapTiler nehmen. Der Token ist trotzdem sinnvoll, wenn du die Mapbox-Stile privat nutzt oder Rechte gekauft hast.

1. Konto bei [account.mapbox.com](https://account.mapbox.com/auth/signup) anlegen — Mapbox verlangt seit Mitte 2026 eine **Kreditkarte** bei der Registrierung; abgebucht wird im Free-Tier nichts.
2. Bestätigungs-Mail klicken.
...
5. In der App: **Einstellungen → Kartenanbieter → Mapbox-Token** einfügen → Speichern.

> 💡 Free-Tier: 50.000 Karten-Loads pro Monat. Vor jedem Video-Render mit einem Mapbox-Stil erinnert die App einmal je Sitzung an die Rechtelage — sie sperrt nichts.

**Schlüssel später ändern**: macOS-Menü → **Reisezoom** → **Einstellungen…** (oder Cmd+,) — Windows/Linux: ⚙-Button oben rechts → **Kartenanbieter**.
...
- **Highlights als Schilder** (Häkchen, Standard an): Gipfel, Pässe, Aussichtspunkte, Wasserfälle,
  ...
  Dazu aus dem Track selbst: höchster und tiefster Punkt (wenn die Tour mindestens 150 m steigt),
...
4. **Im Modul:** Animator, Tour-Map, Daten-Animator und Web-Karte haben **oben in der Seitenleiste eine
   Vorlagen-Leiste** („🧩 Vorlage anwenden…“ · 💾 „Als Vorlage speichern…“; kein Auswahlfeld, denn eine Vorlage ist nur die Basis) für das laufende Projekt.
...
- **Wegpunkt-Schilder (seit v0.9.171, voll gestaltbar seit v0.9.179)** — setze Text-Schilder auf die Route (z.B. „Gipfel erreicht!"). Bereich **„🚩 Schilder"** in der Seitenleiste:
  ...
  - **Optik (alles live):** Form (Sprechblase · Zielbanner · Stecknadel · Wegweiser · Schlicht), **Schildfarbe** + Textfarbe (der **„Schildfarbe"-Picker** — bis 25.09.2026 „Hintergrund" genannt ist die **eine** Box-/Blasenfarbe des Schilds — seit v0.9.271 gibt es keine separate „Akzentfarbe" und kein „Auto" mehr), Schriftart (System · Rundlich · Schmal · Serif · Monospace · Plakativ), Größe/Stärke/Kursiv/**Ausrichtung** (Links/Mitte/Rechts — wirkt sichtbar, sobald du unter **„Breite"** eine feste Mindestbreite > 0 einstellst; bei „Auto" schmiegt sich die Box an den Text und die Ausrichtung hat keinen Spielraum, seit v0.9.479), mehrzeiliger Text, Eckenradius, **Deckkraft Hintergrund** (seit v0.9.478 dimmt der Regler **nur die Schildfarbe** — der Text bleibt voll lesbar), **Außenrand** (Breite+Farbe; bis 25.09.2026 „Rahmen"), **Stangen-Länge** (nur bei Zielbanner + Wegweiser — wie lang die Pfosten/Stange unter dem Schild sind) und **Schlagschatten** (Weichheit ab v0.9.478 bis **0** = harte Kante; die **Richtung** kommt aus dem globalen „Schatten-Richtung"-Regler in der Track-Sektion). **Bild hinzufügen** macht aus dem Schild eine **Foto-Karte** (der Text wird dann zur Bildunterschrift); die Bildgröße ist separat einstellbar.
    ...
    - **Zeiger-Farbe + Zeiger-Position (seit v0.9.481):** Bei **Sprechblase** und **Stecknadel** stellst du im Editor unter **„Zeiger-Farbe"** ein, welche Farbe die Spitze bzw. die Nadel hat — unabhängig von der Schildfarbe (früher „Hintergrund. Der Knopf **„Auto"** bedeutet „wie bisher": der Zeiger folgt dem Hintergrund. Damit geht auch **Hintergrund „Keine" (transparent) + farbige Stecknadel**; vorher verschwand mit dem Hintergrund auch der Zeiger. Darunter wählst du unter **„Zeiger-Position"** zwischen **Links · Mitte · Rechts** — praktisch, wenn die Spitze sonst genau auf der Spur liegt und den Track verdeckt: Schild bleibt stehen, der Zeiger rutscht zur Seite. Steht der Hintergrund auf **„Keine“** und die Zeiger-Farbe auf **„Auto“**, bleibt der Zeiger unsichtbar (es gibt ja keine Hintergrundfarbe, der er folgen könnte) — dann einfach eine eigene Farbe wählen.
    - **Eine Farbe statt zwei (seit v0.9.271):** Früher gab es „Akzentfarbe" **und** „Hintergrund" — beide füllten dieselbe Fläche, das war verwirrend. Jetzt gibt es nur noch den **„Schildfarbe"-Picker** = die Farbe des Schilds (bei der Stecknadel auch des Tropfens). Den **Rahmen** stellst du separat unter „Rahmen" ein.
    - **Schildfarbe „Keine" (transparent, seit v0.9.269):** Bei der Schildfarbe kannst du neben „Auto" jetzt **„Keine"** wählen → die Schild-Box wird komplett **durchsichtig**. Praktisch für **Foto-Karten ohne farbigen Rahmen**: dann siehst du nur das Bild (plus optionalem Rahmen), statt eines farbigen Rands rund ums Foto, der zusammen mit dem Rahmen sonst wie ein **doppelter Rahmen** wirkt.
...
- **Mac: Doppelklick auf .rzproj** funktioniert seit 05.09.2026 auch, wenn GPS Studio schon läuft (vorher nur beim Start).
- **Sternenhimmel (Weltkugel)** (seit 05.09.2026, Beta-Tester-Wunsch) — im Abschnitt **Karte**: Ein/Aus, Dichte, Größe und Funkeln. Sichtbar, sobald die Kamera weit genug draußen ist (Weltanflug, Intro). Vorschau und Video zeigen dieselben Sterne. Bei Mapbox-Stilen gibt es die Gruppe nicht, Mapbox bringt seinen eigenen Himmel mit.
- **Vorschau-Qualität** (seit 07.09.2026) — Einstellungen → Karten, ganz unten: «voll» (wie das Video), «flott» (viermal weniger Kacheln je Bild, Kacheldichte wie vor dem 07.09.) oder «schnell» (zusätzlich halbe Bildauflösung; auf Retina-Macs bringt das kaum Tempo). Hilft, wenn die Vorschau ruckelt. Betrifft nur das Fenster: Video und Standbild rendern immer voll, Kamera, Strecke und Overlays sind identisch. Die App lädt die Oberfläche nach dem Umstellen neu.
- **Quellenzeile: voll oder kurz** (seit 07.09.2026) — in der Overlay-Gruppe „Quellenzeile" neben Ecke und Breite: „voll" zeigt jede Quelle mit Lizenz im Bild (wie bisher). „kurz (Namen + Link)" zeigt die Kurznamen der Quellen im Bild, „bearbeitet" und dahinter „Quellen: <dein Link>" — der Link muss direkt zu den vollständigen Angaben dieses Videos führen (deine Seite, die Videobeschreibung). Die Namen bleiben im Bild, weil viele Lizenzen die sichtbare Nennung verlangen; die Links zu Lizenz und Datensatz stehen hinter dem Link. Ohne Link erscheinen nur Namen und „bearbeitet". Gilt in Vorschau und Video gleich, nicht in der Web-Karte. Nach jedem Render gibt es den Knopf **„Quellentext kopieren"**: der vollständige Text für die Videobeschreibung oder den Abspann (Anbieter, Datensatz, Lizenz mit Links, „Daten bearbeitet", dein Link).
- **Quellen-Register** (seit 07.09.2026) — in den Einstellungen unter **Karten** in der Rechte-Tabelle aufklappbar: je Kartendienst die Datenlizenz mit Link, ob kommerzielle Videos freigegeben sind (✅ geprüft und erlaubt · 💰 Rechte kaufen · ⚠️ nicht verifiziert oder Server-Regeln · ❌ nicht erlaubt), die vorgeschriebene Nennung im Bild und das Prüfdatum. Alle Dienste wurden am 07.09.2026 einzeln nachgelesen; die Nennung im Bild kommt seither aus diesem Register, mit Änderungshinweis, wo die Lizenz ihn verlangt. Mindestens halbjährlich wird neu geprüft; ist ein Eintrag überfällig, steht dort ein Hinweis. Die Karten-Abzeichen im Stil-Wähler folgen dem Register: CyclOSM und Humanitarian sind für Videos nicht freigegeben (der Server von OpenStreetMap France bedient nur nichtkommerzielle Seiten), OpenStreetMap und OpenTopoMap tragen den Hinweis „Server-Regeln beachten" (Bild-für-Bild-Rendern nur nach Absprache oder mit eigenem Kachelserver). Das ist unsere Lesart, keine Rechtsberatung — die Links stehen daneben.
- **Schärfe** (seit 07.09.2026) — der letzte Regler der „Luftbild-Optik" bzw. „Karten-Optik" (unter „Farbton"), 0–100 % (Standard 0): eine Unschärfemaske auf dem Kartenbild, in Vorschau und Video gleich (nicht in den Web-Karten-Exporten). Wirkt nur auf das Kartenbild, nicht auf Strecke, Schilder, Beschriftung, Zahlen, Höhenprofil und Quellenzeile. Hintergrund: Die freie Sentinel-2-Ebene (10 m, Stand 2016) ist über Inseln und Küsten ohne amtliches Luftbild weich — das ist das Datenmaterial, nicht die App. 40–60 % machen sie lesbar; darüber wird es körnig. Seit demselben Tag holen alle Rasterkarten auf Retina-Bildschirmen und im Video ein bis zwei Kachelstufen tiefer, damit ein Kachelpixel etwa auf ein Bildpixel fällt (vorher 2- bis 5-fach vergrößert).
...
**Formate für soziale Netze (seit 25.09.2026):** Unter den Auflösungen gibt es eine zweite Reihe **Insta 1:1** (1080×1080), **Insta 4:5** (1080×1350) und **Story 9:16** (1080×1920). **„Als Tour-Map öffnen“** im Animator übernimmt Kartenstil und Ausrichtung und passt den Ausschnitt so an, dass derselbe Bereich im Tour-Map-Format zu sehen ist; der Ausrichtungsregler zeigt denselben Wert wie die Karte.
...
- **Alte Sicherungen aufräumen:** Sichert die App dieselben Fotos mehrmals, bleiben die **älteste** (unberührte Originale) und die **neueste**; alle dazwischen verschwinden automatisch. Beim ersten Schreiben einer neuen Tour fragt der Geotagger, ob **Sicherungen früherer Touren** weg dürfen (*Ansehen*, *Behalten*, *Löschen*). Gelöschte Sicherungen liegen noch 14 Tage im Papierkorb von GPS Studio. Automatisch gelöscht wird sonst nichts; liegen mehr als 20 Sicherungen, warnt die App beim Start und du hakst an, was weg kann.
...
- **📥 Abschnitt A→B als neue Tour ins Archiv …** (seit v0.9.718) — Anker A und B setzen, klicken, Namen eingeben: Die Punkte von A bis B (mit Zeiten und Sensoren) werden eine **eigene, neue Tour im Archiv**. Der Track im Inspektor bleibt, wie er ist. Danach: *Im Archiv zeigen* (die neue Tour ist dort ausgewählt), *Hier weiterarbeiten* oder *Wieder entfernen* (Papierkorb). Typischer Fall: Autofahrt und Wanderung stecken in einer Datei — die Wanderung wird zur eigenen Tour. Als Datei nach draußen geht sie danach über **Datei → Als GPX exportieren**.
...
**Bearbeiten (seit v0.9.709):** Jeder Eintrag hat ein **⋯-Menü** (auch Rechtsklick in der Liste oder auf einen Block im Zeitstrahl): *Umbenennen*, *Notiz*, *Art ändern* (Fahrt, Fähre, Wanderung, Spaziergang, Rad, Laufen, Wassersport, Pause), *Aktivität teilen* — hier (im Zeitstrahl an der Mausstelle), bei Anker A, bei einer Uhrzeit oder in der Mitte; geteilt wird nur der Eintrag, nie der Track —, *Mit vorherigem/nächstem zusammenlegen*, *Löschen* — das Gelöschte geht im Nachbarn auf. **Grenzen ziehen:** im Zeitstrahl den Übergang zwischen zwei Blöcken packen und schieben. **＋ A→B** macht aus dem Abschnitt zwischen Anker A und B einen eigenen Eintrag, **📍 Punkt** setzt mit dem nächsten Kartenklick einen eigenen Punkt (mit Namen). Alles ist ein **⌘Z**-Schritt; deine Handarbeit bleibt auch nach ↻ (neu erkennen) stehen.

**Vermutete Arten bestätigen (seit v0.9.713):** War die Erkennung unsicher, steht beim Eintrag die Marke **„vermutet“**. Ein Klick darauf — oder Rechtsklick/⋯ in Liste, Zeitstrahl und auf der Karte — bietet ganz oben **„✓ Rad bestätigen“** (bzw. die angezeigte Art); daneben kannst du wie gewohnt eine andere Art wählen. Bestätigte Einträge sind Handarbeit und bleiben auch nach ↻ Neu-Erkennen. Im **großen Fenster** zeigt das Häkchen **„nur vermutete“** genau diese Einträge; alle markieren → **„✓ Vermutete bestätigen“**. Alles mit ⌘Z.
...
**Auf der Karte (seit v0.9.713):** Höchster Punkt, eigene Punkte und Sehenswürdigkeiten stehen als **runde Marken auf der Karte**, Befunde als farbige Punkte. **Klick auf eine Marke** — oder auf den Punkt in Liste oder Zeitstrahl — öffnet einen Kasten, der sagt, **was das ist** (z. B. „Sehenswürdigkeit aus OpenStreetMap · Burg“, „Höchster Punkt der Tour · 3.746 m“), mit Uhrzeit, Ort und den Knöpfen *Umbenennen*, *Notiz*, *Löschen*; eine Sehenswürdigkeit, die noch nicht im Logbuch steht, bekommt *Ins Logbuch übernehmen*. Ein **Befund** sagt, was kaputt ist, was die Reparatur tun würde, und fragt gleich: **🩹 Reparieren** (betrifft alle Stellen dieser Art, ⌘Z geht), *Nächste Stelle*, *Ist so in Ordnung*. **Rechtsklick auf den Track** öffnet dasselbe Menü wie im Zeitstrahl (umbenennen, Art, Aktivität hier teilen, zusammenlegen …) plus *Eigenen Punkt hier setzen* und *Anker hier*. **Zoom-Kopplung:** Zoomst du im Zeitstrahl, zeigt die Karte denselben Abschnitt und hebt ihn hell hervor; ziehst oder zoomst du die Karte, zeigt der Zeitstrahl den sichtbaren Abschnitt. **Häkchen „POIs“ aus** nimmt die Sehenswürdigkeiten überall heraus — Zeitstrahl-Zeile, Liste und Karte. Ein gelöschter automatischer Punkt (auch ein POI) kommt beim Neu-Erkennen nicht wieder.
...
**Kleines Fenster (seit 25.09.2026):** Bleibt der Fortschritt bei „Projekt öffnen …“ stehen, sagt die Anzeige jetzt, worauf gewartet wird (z. B. „1 Schild-Bild laden“). Ein Schildbild, das nicht lädt, hält den Render nach 30 s nicht mehr auf. Ist die Vorschau sehr klein (unter 640 Pixel breit, etwa bei kleinem App-Fenster), rendert GPS Studio trotzdem mit 640 Pixel Breite: gleicher Ausschnitt, aber Linien, Schrift und Quellenzeile fein statt grob vergrößert.
