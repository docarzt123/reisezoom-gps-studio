...
### Changed
- Attribution readable in the preview and the video: the source line at the bottom right is no longer shrunk with the preview scale (about 5 px tall in the preview and 12 px in a 1080p video, so you could not see where to place the watermark). It keeps its normal size in the preview and appears at the same relative size in the video (about 28 px at 1080p). / Quellenzeile lesbar in Vorschau und Video: die Nennung unten rechts wird nicht mehr mit dem Vorschau-Maßstab verkleinert (etwa 5 px in der Vorschau, 12 px im 1080p-Video, man sah nicht, wo das Wasserzeichen hin soll). Sie behält in der Vorschau ihre normale Größe und erscheint im Video in derselben relativen Größe (etwa 28 px bei 1080p).
