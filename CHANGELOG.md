...
- Investigated: the flickering line along terrain tile seams (preview and video, Schorfheide) is a MapLibre terrain artefact at the joints between terrain tiles of different zoom levels (T-junctions); it flickers with any sub-pixel camera move, is absent with an exactly repeated camera, and was in the old generator's videos as well (measured 638 vs 371 changing pixels). Terrain mesh sizes 32/64/252/256, render-texture quality, texture pool and exaggeration do not cure it (256 even tears: 16-bit index overflow). Documented in IDEAS for a stitching patch. / Untersucht: der flimmernde Strich an den Gelände-Kachelnähten (Vorschau und Video, Schorfheide) ist ein MapLibre-Gelände-Artefakt an den Stößen zwischen Geländekacheln verschiedener Zoomstufe (T-Stöße); er flimmert bei jeder Sub-Pixel-Kamerabewegung, fehlt bei exakt gleicher Kamera und war in den Videos des alten Generators genauso (gemessen 638 gegen 371 Wechselpixel). Geländenetz 32/64/252/256, Textur-Qualität, Textur-Pool und Überhöhung heilen es nicht (256 reißt sogar: 16-Bit-Index-Überlauf). In IDEAS für einen Stitching-Patch festgehalten.
