...
QUELLEN: list[dict] = [{'id': 'de-be',
 ...
 {'id': 'at',
  ...
  'license_hinweis': 'Open Government Data Österreich Lizenz CC-BY 4.0 (Creative Commons Attribution 4.0 '
                     'International)'},
 {'id': 'dk',
  'provider': 'Klimadatastyrelsen (früher SDFI) / GeoDanmark — Dataforsyningen',
  'dataset': 'GeoDanmark Ortofoto forår (12,5 cm, jährlich) – WMTS orto_foraar_webm_DAF (Web Mercator, DFD_GoogleMapsCompatible)',
  'dataset_url': 'https://dataforsyningen.dk/data/2776',
  'license': 'Frie offentlige geodata (Dataforsyningen, offene Lizenz)',
  'license_url': 'https://dataforsyningen.dk/vilkaar',
  'commercial_video': 'true',
  'modification_notice_required': False,
  'onscreen_credit': '© Klimadatastyrelsen / GeoDanmark, Ortofoto forår',
  'service_terms_url': 'https://dataforsyningen.dk/vilkaar',
  'service_limits': 'Eigener Token Pflicht (kostenloses Konto auf dataforsyningen.dk, „Brugeradministration → Token“). '
                    'Keine Rate-Limits veröffentlicht. Zoom 0–20.',
  'render_server': 'ok',
  'credit_hinweis': '© Klimadatastyrelsen / GeoDanmark, Ortofoto forår',
  'credit_kurz': '© GeoDanmark',
  'license_hinweis': 'Frie geodata: Nennung Pflicht, kommerzielle Nutzung erlaubt; Token je Nutzer.',
  'confidence': 'mittel',
  'notes': 'Dataforsyningen: „frie offentlige geodata“ unter offener Lizenz, Nennung Pflicht. Web-Mercator-Dienst am 18.09.2026 '
           'mit Fremd-Token geprüft (Kachel Kopenhagen z15 = 36 KB JPEG). Genauen Lizenztext bei der nächsten Prüfung nachlesen.',
  'sources': ['https://dataforsyningen.dk/data/2776', 'https://datafordeler.dk/dataoversigt/geodanmark-ortofoto/ortofoto-foraar-web-mercator-wmts/'],
  'checked_at': '2026-09-18'},
 {'id': 'fi',
  'provider': 'Maanmittauslaitos (National Land Survey of Finland, NLS)',
  'dataset': 'NLS Ortokuva – Karttakuvapalvelu WMTS (avoin-karttakuva), WGS84_Pseudo-Mercator',
  'dataset_url': 'https://www.maanmittauslaitos.fi/en/maps-and-spatial-data/datasets-and-interfaces/product-descriptions/orthophotos',
  'license': 'CC BY 4.0',
  'license_url': 'https://www.maanmittauslaitos.fi/en/opendata-licence-cc40',
  'commercial_video': 'true',
  'modification_notice_required': False,
  'onscreen_credit': '© Maanmittauslaitos (NLS Finland), CC BY 4.0',
  'service_terms_url': 'https://www.maanmittauslaitos.fi/en/maps-and-spatial-data/datasets-and-interfaces/map-interface-services/map-image-service-wms-wmts',
  'service_limits': 'Eigener api-key Pflicht (kostenlos, Formular auf maanmittauslaitos.fi). Keine Rate-Limits veröffentlicht.',
  'render_server': 'ok',
  'credit_hinweis': '© Maanmittauslaitos (National Land Survey of Finland)',
  'credit_kurz': '© NLS Finland',
  'license_hinweis': 'CC BY 4.0: Nennung Pflicht, kommerzielle Nutzung erlaubt; Schlüssel je Nutzer.',
  'confidence': 'mittel',
  'notes': 'Kachelvorlage nach NLS-Doku (WMTS „ortokuva“, WGS84_Pseudo-Mercator, /{z}/{y}/{x}.jpg?api-key=). Ohne Schlüssel '
           'antwortet der Dienst mit 401 — 18.09.2026 nicht mit echtem Schlüssel geprüft.',
  'sources': ['https://www.maanmittauslaitos.fi/en/maps-and-spatial-data/datasets-and-interfaces/map-interface-services/map-image-service-wms-wmts-1',
              'https://www.maanmittauslaitos.fi/en/opendata-licence-cc40'],
  'checked_at': '2026-09-18'},
 {'id': 'nz',
  'provider': 'Toitū Te Whenua Land Information New Zealand (LINZ) — LINZ Basemaps',
  'dataset': 'LINZ Basemaps „aerial“ (Mosaik aus LINZ- und Regionsrats-Luftbildern), XYZ WebMercatorQuad',
  'dataset_url': 'https://basemaps.linz.govt.nz/',
  'license': 'CC BY 4.0',
  'license_url': 'https://www.linz.govt.nz/guidance/data-service/linz-basemaps-guide',
  'commercial_video': 'true',
  'modification_notice_required': False,
  'onscreen_credit': 'Sourced from LINZ Basemaps (CC BY 4.0)',
  'service_terms_url': 'https://basemaps.linz.govt.nz/docs/user-guide/api-documentation/',
  'service_limits': 'API-Schlüssel laut LINZ Pflicht („api=“), kostenlos über basemaps.linz.govt.nz. Nennung + Link zu LINZ '
                    'verlangt („mapping libraries do not do this automatically“). Keine Rate-Limits veröffentlicht.',
  'render_server': 'ok',
  'credit_hinweis': 'Sourced from LINZ Basemaps — Toitū Te Whenua Land Information New Zealand',
  'credit_kurz': '© LINZ',
  'license_hinweis': 'CC BY 4.0: Nennung Pflicht, kommerzielle Nutzung erlaubt; Schlüssel je Nutzer.',
  'confidence': 'mittel',
  'notes': 'Kacheln kamen am 18.09.2026 auch ohne Schlüssel (z15 Auckland, WebP) — die Doku verlangt ihn trotzdem, deshalb '
           'als Schlüssel-Region geführt. Enthält Luftbilder mehrerer Regionalräte (jeweils CC BY 4.0).',
  'sources': ['https://www.linz.govt.nz/guidance/data-service/linz-basemaps-guide/how-use-linz-basemaps-apis',
              'https://basemaps.linz.govt.nz/docs/user-guide/technical-documentation/'],
  'checked_at': '2026-09-18'},
 {'id': 'si',
  'provider': 'Geodetska uprava Republike Slovenije (GURS)',
  'dataset': 'Ortofoto DOF5 (25 cm, Jahrgänge 2023–2025) – öffentlicher WMS ows-pub-wms, Layer SI.GURS.ZPDZ:DOF5',
  'dataset_url': 'https://podatki.gov.si/dataset/ortofoto',
  'license': 'CC BY 4.0',
  'license_url': 'https://www.e-prostor.gov.si/en/access-to-geodetic-data/',
  'commercial_video': 'true',
  'modification_notice_required': False,
  'onscreen_credit': '© GURS – Geodetska uprava RS, DOF (CC BY 4.0)',
  'service_terms_url': 'https://storitve.eprostor.gov.si/ows-pub-wms/wms?request=getCapabilities',
  'service_limits': 'Capabilities: AccessConstraints „Ni omejitev“, Fees „Navedba vira“ (Quellenangabe). Keine Rate-Limits '
                    'oder Cache-Regeln veröffentlicht. EPSG:3857, PNG mit Alpha.',
  'render_server': 'ok',
  'credit_hinweis': '© GURS – Geodetska uprava Republike Slovenije, DOF',
  'credit_kurz': '© GURS',
  'license_hinweis': 'CC BY 4.0: Nennung Pflicht, kommerzielle Nutzung erlaubt.',
  'confidence': 'hoch',
  'notes': 'e-prostor: Geodaten der Republik Slowenien unter CC BY 4.0 (kommerziell und nicht-kommerziell, Quellenangabe). '
           'GetMap Ljubljana 18.09.2026 geprüft (256 px, RGBA).',
  'sources': ['https://www.e-prostor.gov.si/en/access-to-geodetic-data/',
              'https://storitve.eprostor.gov.si/ows-pub-wms/wms?request=getCapabilities'],
  'checked_at': '2026-09-18'},
 {'id': 'au-nsw',
  'provider': 'NSW Government – Department of Customer Service, Spatial Services',
  'dataset': 'NSW Imagery Basemap (public/NSW_Imagery MapServer, Kacheln EPSG:3857)',
  'dataset_url': 'https://datasets.seed.nsw.gov.au/dataset/nsw-imagery',
  'license': 'CC BY 4.0',
  'license_url': 'https://creativecommons.org/licenses/by/4.0/',
  'commercial_video': 'true',
  'modification_notice_required': False,
  'onscreen_credit': '© State of New South Wales (Spatial Services), NSW Imagery (CC BY 4.0)',
  'service_terms_url': 'https://maps.six.nsw.gov.au/arcgis/rest/services/public/NSW_Imagery/MapServer',
  'service_limits': 'Öffentlicher ArcGIS-Kacheldienst ohne Schlüssel; keine Rate-Limits veröffentlicht. Kachelpfad '
                    '/tile/{z}/{y}/{x}. Enthält im Hintergrund Landsat-Material (Übersicht).',
  'render_server': 'ok',
  'credit_hinweis': '© State of New South Wales (Spatial Services), NSW Imagery',
  'credit_kurz': '© NSW Spatial Services',
  'license_hinweis': 'CC BY 4.0: Nennung Pflicht, kommerzielle Nutzung erlaubt.',
  'confidence': 'hoch',
  'notes': 'SEED/data.gov.au: Spatial-Services-Material unter CC BY 4.0. Kachel Sydney 18.09.2026 geprüft.',
  'sources': ['https://datasets.seed.nsw.gov.au/dataset/nsw-imagery',
              'https://www.data.gov.au/data/dataset/nsw-1-ae273ee6312d4e1e83ee7b3a9565abdf'],
  'checked_at': '2026-09-18'},
 {'id': 'be-vl',
  'provider': 'Digitaal Vlaanderen (Vlaamse overheid)',
  'dataset': 'Orthofotomozaïek, middenschalig, winteropnamen, kleur, meest recent, Vlaanderen – WMS OMWRGBMRVL (Layer „Ortho“)',
  'dataset_url': 'https://www.vlaanderen.be/datavindplaats/catalogus/orthofotomozaiek-middenschalig-winteropnamen-kleur-meest-recent-vlaanderen',
  'license': 'Modellicentie Gratis Hergebruik v1.0',
  'license_url': 'https://data.vlaanderen.be/id/licentie/modellicentie-gratis-hergebruik/v1.0',
  'commercial_video': 'true',
  'modification_notice_required': False,
  'onscreen_credit': 'Bron: Luchtopnamen Digitaal Vlaanderen',
  'service_terms_url': 'https://www.vlaanderen.be/digitaal-vlaanderen/onze-oplossingen/geografische-webdiensten/gebruiksrecht-en-privacyverklaring-geografische-webdiensten',
  'service_limits': 'Dienst kostenlos („Het gebruik van de service is kosteloos“, Capabilities); keine Rate-Limits, Cache- '
                    'oder User-Agent-Regeln veröffentlicht; keine Garantie auf Verfügbarkeit. Kontakt digitaal.vlaanderen@vlaanderen.be.',
  'confidence': 'hoch',
  'notes': 'Metadaten der Jahrgangs-Mosaike (z. B. 2024, metadata.vlaanderen.be 72ecb198-…) nennen die Modellicentie Gratis '
           'Hergebruik (freie, auch kommerzielle Weiterverwendung mit Quellenangabe) und als Pflichtvermerk „Bron: Luchtopnamen '
           'Digitaal Vlaanderen“. Der WMS liefert EPSG:3857 als PNG mit Alpha (außerhalb Flanderns durchsichtig → Wallonien '
           'scheint im Stapel durch). Winter-Mosaik = laubfrei, weniger Schatten.',
  'sources': ['https://geo.api.vlaanderen.be/OMWRGBMRVL/wms?SERVICE=WMS&REQUEST=GetCapabilities',
              'https://metadata.vlaanderen.be/srv/api/records/72ecb198-84d1-4015-82c2-8e10a3c16cdf'],
  'render_server': 'ok',
  'credit_hinweis': 'Bron: Luchtopnamen Digitaal Vlaanderen',
  'credit_kurz': 'Digitaal Vlaanderen',
  'license_hinweis': 'Modellicentie Gratis Hergebruik: freie Weiterverwendung inkl. kommerziell, Quellenangabe Pflicht.',
  'checked_at': '2026-09-17'},
 {'id': 'be-wa',
  'provider': 'Service public de Wallonie (SPW)',
  'dataset': 'Orthophotos – dernière campagne disponible (ORTHO_LAST, 25 cm) – WMS IMAGERIE/ORTHO_LAST (Layer „0“)',
  'dataset_url': 'https://geoportail.wallonie.be/catalogue/dfc9f3a2-adff-4b7f-ab77-8a890c4cabbb.html',
  'license': 'CC BY 4.0',
  'license_url': 'https://creativecommons.org/licenses/by/4.0/',
  'commercial_video': 'true',
  'modification_notice_required': False,
  'onscreen_credit': 'Service public de Wallonie (SPW) – Orthophotos (CC BY 4.0)',
  'service_terms_url': 'https://geoportail.wallonie.be/files/documents/ConditionsSPW/LicServicesSPW.pdf',
  'service_limits': 'Dienst kostenlos für jeden Nutzer (Art. 3 §1). Art. 5 §1: keine „utilisation disproportionnée ou inadaptée“ '
                    '(nichts, was die Server verstopft); §3: vom Dienst gelieferte Vermerke dürfen nicht entfernt werden; §4: '
                    'Quellenangabe nicht verändern. Art. 6 §4: SPW darf den Zugang nach Kapazität begrenzen. Kontakt '
                    'helpdesk.carto@spw.wallonie.be.',
  'confidence': 'hoch',
  'notes': 'Katalog: Daten unter CC-BY 4.0, Zitiervorschlag „Service public de Wallonie (SPW) - Orthophotos - Vues aériennes les '
           'plus récentes“. Esri-WMS, EPSG:3857, PNG mit Alpha (außerhalb Walloniens durchsichtig). Jährliche Kampagne.',
  'sources': ['https://geoportail.wallonie.be/catalogue/e2a615fe-7a2c-4eb3-9dc3-63f466538dda.html',
              'https://geoportail.wallonie.be/catalogue/dfc9f3a2-adff-4b7f-ab77-8a890c4cabbb.html',
              'https://geoportail.wallonie.be/files/documents/ConditionsSPW/LicServicesSPW.pdf'],
  'render_server': 'ok',
  'credit_hinweis': 'Service public de Wallonie (SPW) – Orthophotos',
  'credit_kurz': '© SPW',
  'license_hinweis': 'CC BY 4.0: Nennung Pflicht, kommerzielle Nutzung erlaubt.',
  'checked_at': '2026-09-17'},
 {'id': 'sk',
  'provider': 'Úrad geodézie, kartografie a katastra SR (ÚGKK SR) / Geodetický a kartografický ústav Bratislava (GKÚ)',
  'dataset': 'Ortofotomozaika SR – WMS zbgis_ortofoto_wms (Layer „1“ = aktuelle Mosaik)',
  'dataset_url': 'https://www.gku.sk/gku/aktuality/ortofotomozaika.html',
  'license': 'CC BY 4.0',
  'license_url': 'https://creativecommons.org/licenses/by/4.0/',
  'commercial_video': 'true',
  'modification_notice_required': False,
  'onscreen_credit': '© ÚGKK SR / GKÚ Bratislava, Ortofotomozaika SR (CC BY 4.0)',
  'service_terms_url': 'https://zbgisws.skgeodesy.sk/zbgis_ortofoto_wms/service.svc/get?SERVICE=WMS&REQUEST=GetCapabilities',
  'service_limits': 'Capabilities: AccessConstraints „CC BY Creative Commons Attribution 4.0“, Fees „bez poplatkov“. Keine '
                    'Rate-Limits oder Cache-Regeln veröffentlicht. Seit 27.08.2025 als offene Daten (Download + Dienste).',
  'confidence': 'mittel',
  'notes': 'Lizenz direkt aus den Capabilities und der GKÚ-Downloadseite (Autor GKÚ Bratislava, Licencia CC-BY 4.0). Die '
           'Seite geoportal.sk/sk/udaje/ortofotomozaika (Nutzungsbedingungen) war am 17.09.2026 nicht abrufbar (Zertifikat) — '
           'Wortlaut der Quellenangabe daher unsere Formel, bei der nächsten Prüfung nachlesen.',
  'sources': ['https://zbgisws.skgeodesy.sk/zbgis_ortofoto_wms/service.svc/get?SERVICE=WMS&REQUEST=GetCapabilities',
              'https://www.gku.sk/gku/produkty-sluzby/na-stiahnutie/zbgis.html'],
  'render_server': 'ok',
  'credit_hinweis': '© ÚGKK SR / GKÚ Bratislava, Ortofotomozaika SR',
  'credit_kurz': '© ÚGKK SR',
  'license_hinweis': 'CC BY 4.0: Nennung Pflicht, kommerzielle Nutzung erlaubt.',
  'checked_at': '2026-09-17'},
 {'id': 'cz',
